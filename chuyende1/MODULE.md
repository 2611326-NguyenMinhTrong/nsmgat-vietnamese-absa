...
| `SO_TAY_LENH.md` (gốc repo, **không đẩy lên GitHub**) | [REQ-011] Mọi lệnh của repo xếp **theo nhu cầu**, mô tả đầy đủ kèm bẫy thường gặp. Thêm công cụ mới thì cập nhật file này cùng lúc |
| `scripts/cham_trac_nghiem.py` + `tests/test_cham_trac_nghiem.py` (**giữ ở máy, không đẩy lên GitHub**) | [REQ-009/REQ-010] Chấm trắc nghiệm đọc bài báo: luật đạt hai điều kiện, chỉ ra mục cần đọc lại, ghi/ẩn đáp án ngay trên phiếu. Test canh đề ↔ đáp án khớp nhau |
